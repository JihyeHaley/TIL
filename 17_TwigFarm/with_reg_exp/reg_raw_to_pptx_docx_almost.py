...
def raw_docx_to_dict(docx_files_list):
    ...
    for docx_file_list in docx_files_list:
        ...
        #     text_list = docx_result_pre.split('. ')
        #     for text in text_list:
        #         if text == "":
        #             continue
        ...
        docx_results = list(filter(None, docx_results_pre))
...
def all_contents_dict():
    ...
    # ------------------------------------------------------------------------------------
    # log 출력 (파일명 확인하기 위해서)
    completed_log = open(f'/Users/jihyeoh/Desktop/Farm/4_2019한국표준협회/log_stabdard_50' + '.txt', "w+")
...
def dict_to_excel():
    ...
    # ------------------------------------------------------------------------------------
    # excel 밖으로 빼내기
    workbook = xlsxwriter.Workbook('/Users/jihyeoh/Desktop/Farm/4_2019한국표준협회/4_xlsx/standard50_.xlsx')
