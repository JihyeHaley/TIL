...
xlsxFile = './일본어_파싱_데이터/이노룰스 번역본 문서 (일본어)/5.1 InnoRules 7.2 서버 Message.xlsx'
...
ko_en_dict = dict()
workbook = xlsxwriter.Workbook('./result_5_1_ko_jp_.xlsx') 
