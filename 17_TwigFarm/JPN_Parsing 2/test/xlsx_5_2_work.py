...
# 한/영
or_xlsxFile = './일본어_파싱_데이터/이노룰스 사전모음 (한,영)/5-2. InnoRules화면Caption-TM.xlsx'
...
# 파싱된 한/일
pr_xlsxFile = './result_5_2_3_ko_jp_.xlsx'
...
workbook = xlsxwriter.Workbook('./worked_5_2_ko_en_jp_.xlsx') 
