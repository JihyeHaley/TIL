...
def neitherKoNorEn(text):
    ...
    return bool(neither.fullmatch(text))ß
...
>>>>>>> 5fd1ae1c127d7fa2be042d526da83220bfe3febb:utils/regex_functions.py
...
def strip_regex_all(text):    
    ...
    # [숫자 + . + 공백 + 단어] -> [숫자 + . + 단어]: 공백제거
    order_regex = r'(\d)\.\s(\w.*)'
    text = re.sub(order_regex, r"\1.\2", text)
