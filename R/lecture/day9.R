...
plot(국어, type="o", col="blue")
lines(수학, type="o", pch=16, lty=1, col="red")     
title(main="성적그래프", col.main="red", font.main=4)
...
pie(성적$국어, clockwise=T, labels=paste(성적$성명, "-", 성적$국어), col=rainbow(10)) #시곕방향으로
