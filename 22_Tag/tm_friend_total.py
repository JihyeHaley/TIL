...
# tm 불러오기
from raw_tm_to_list import call_tagMT_ko_total_lan
# tag 가져오기
...
def test_excel(which_list):
    ...
    workbook = xlsxwriter.Workbook('./results/total/total_regex_test_ko' + timestamp + '_.xlsx')
    ...
    for idx, sent in enumerate(which_list):
        ...
        if len(tag_found) != len(tag_found_close):
            ...
            worksheet.write(a_idx, path_total_list[idx])
