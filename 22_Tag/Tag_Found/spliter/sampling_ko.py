...
def ko_en_spliter():
    ...
    workbook_ko_en = xlsxwriter.Workbook('./tagMT_ko_en_split'+ '.xlsx')
    ...
    completed_ko_en = open(f'./ko_en_choice_idx'+ '.txt', "w+")
...
def ko_ja_spliter():
    ...
    workbook_ko_ja = xlsxwriter.Workbook('./tagMT_ko_ja_split'+ '.xlsx')
    ...
    completed_ko_ja = open(f'./ko_ja_choice_idx'+ '.txt', "w+")
