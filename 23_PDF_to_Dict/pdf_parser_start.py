"""
    ...
    script example: python pdf_parser_start.py -s "사회과학" -r "/Users/haley/Desktop/"
...
parser.add_argument(
    ...
    "--root_path",
    type=str,
    default= str(Path.home()) + "/주식회사 트위그팜/NIA - 04_용어사전정리/",
    help="<type: str> root directory for each category document files (Default path = $HOME/주식회사 트위그팜/NIA - 04_용어사전정리/)"
)
...
if __name__ == '__main__':
    ...
    # python pdf_parser_start.py -s "사회과학" -r "/Users/twigfarm/Desktop/"
